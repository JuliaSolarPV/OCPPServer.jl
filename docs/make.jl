...
DocMeta.setdocmeta!(OCPPServer, :DocTestSetup, :(using OCPPServer); recursive = true)
...
makedocs(;
    ...
    repo = "https://github.com/JuliaSolarPV/OCPPServer.jl/blob/{commit}{path}#{line}",
    sitename = "OCPPServer.jl",
    format = Documenter.HTML(; canonical = "https://JuliaSolarPV.github.io/OCPPServer.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/JuliaSolarPV/OCPPServer.jl")
